...
import { StickyHeaderController } from '@/features/sticky-header';
                ...
                header={
                  <Header
                    data={{
                      navListItems: [
                        {
                          label: messages?.Header?.Nav?.OurCompany ?? 'Our Company',
                          href: '/about',
                        },
                        {
                          label: messages?.Header?.Nav?.Locations ?? 'Locations',
                          href: '/locations',
                        },
                        {
                          label: messages?.Header?.Nav?.Contact ?? 'Contact',
                          href: '/contact',
                        },
                      ],
                      logoSrc,
