      ...
      <Section className="min-h-[380px] w-full absolute top-10 left-0 z-10 xl:top-[76px] xl:min-h-[292px]">
        <div className="container">
          <div
            ...
            <div
              className="h-[380px] relative z-20 text-white flex flex-col gap-6 items-center justify-center px-2 xl:flex-row xl:h-[292px] xl:max-h-[292px] xl:justify-between xl:gap-10 xl:px-24"
            >
        ...
        <div className=" container relative pb-16 pt-60 xl:pt-32">
          <div className="col-start-2 col-span-10  flex flex-col gap-12 xl:col-start-0 xl:col-span-12">
            ...
            <div className="flex flex-col items-center gap-8 xl:gap-12 text-white
              ...
              <hr className="w-full border-[1.5px]   border-dark-grey opacity-50
