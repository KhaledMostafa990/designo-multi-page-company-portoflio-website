  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-6 justify-center px-3 py-8  md:flex-1 md:items-center hover:group-last:text-white">
        <h3 className="text-primary-default group-hover:text-white font-semibold uppercase text-lg text-center tracking-[5px]">{project.title}</h3>
        <p className="text-black group-hover:text-white text-center max-w-[250px]">{project.description}</p>
      </div>
    </div>
  );
}
